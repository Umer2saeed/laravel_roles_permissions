<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('roles.index') }}" class="shadow bg-gray-500 hover:bg-gray-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-full">Back</a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.update', $role->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('name', $role->name) }}" class="w-1/2 border-gray-300 shadow-sm rounded-lg text-gray-700 leading-tight" id="name" type="text" name="name" placeholder="Enter Role">
                                @error('name')
