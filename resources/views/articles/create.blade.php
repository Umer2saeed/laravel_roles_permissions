                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('title') }}" class="w-1/2 border-gray-300 shadow-sm rounded-lg text-gray-700 leading-tight" id="title" type="text" name="title" placeholder="Title">
                                @error('title')
                            ...
                            <div class="my-3">
                                <textarea class="w-1/2 border-gray-300 shadow-sm rounded-lg text-gray-700 leading-tight" id="text" name="text" placeholder="Content" cols="30" rows="10">{{ old('text') }}</textarea>
                            </div>

                            <label class="text-md font-medium" for="author">Author</label>
                            <div class="my-3">
                                <input value="{{ old('author') }}" class="w-1/2 border-gray-300 shadow-sm rounded-lg text-gray-700 leading-tight" id="author" type="text" name="author" placeholder="Author">
                                @error('author')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
